...
const TailwindInputsConfig = {
       
standard: 'border-b-2 border-gray-200 bg-transparent w-54 text-gray my-4 mx-4 py-2 px-2 leading-tight focus:outline-none ',
...
export default TailwindInputsConfig;
